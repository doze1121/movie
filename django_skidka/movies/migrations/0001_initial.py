    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descriotion', models.TextField(verbose_name='Описание')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actros', models.ManyToManyField(related_name='film_actor', to='movies.actor', verbose_name='актеры')),
                ('catagory', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='movies.catagory', verbose_name='Категория')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='movies.revie', verbose_name='Родитель')),
            ],
            options={
                'verbose_name': 'Отзыв',
